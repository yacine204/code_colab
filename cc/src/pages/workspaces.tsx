        ...
        <div className="min-h-screen bg-[#0a0a0a] p-8 flex justify-center">
            <div className="w-full max-w-4xl bg-[#111] border border-green-500/10 rounded-2xl p-6">
                ...
                <div className="flex items-center justify-between mb-5">
                    <div>
                        <span className="text-sm font-semibold text-zinc-300">Workspaces</span>
                        <span className="text-xs text-zinc-600 ml-2">{workspaces.length} workspaces</span>
                    </div>
                    <Button context="+ New" variant="run" trigger={() => navigate("/workspace/new")} />
                </div>
                ...
                <div className="flex flex-col divide-y divide-[#1a1a1a]">
                    {filtered.map(ws => (
                        <div key={ws.id} className="flex items-start justify-between py-4 gap-4">
